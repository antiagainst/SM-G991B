...
static int exynos2100_secgpio_get_nr_gpio(void)
{
	unsigned int i, j;
	int nr_gpio = 0;
	const struct samsung_pin_ctrl *pin_ctrl = exynos2100_of_data.ctrl;
	unsigned int num_ctrl = exynos2100_of_data.num_ctrl;
...
static struct gpio_dvs_t exynos2100_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.skip_grps = "gpv", /* DMIC(VTS) */
};

const struct secgpio_dvs_data exynos2100_secgpio_dvs_data = {
	.gpio_dvs = &exynos2100_secgpio_dvs,
	.get_nr_gpio = exynos2100_secgpio_get_nr_gpio,
};
EXPORT_SYMBOL_GPL(exynos2100_secgpio_dvs_data);
#endif /* CONFIG_PINCTRL_SEC_GPIO_DVS */
