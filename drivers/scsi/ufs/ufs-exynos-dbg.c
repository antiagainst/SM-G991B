...
#define UFS_CPORT_PRINT         1       /*CPORT printing enable:1 , disable:0*/
...
static struct exynos_ufs_sfr_log ufs_log_sfr[] = {
	...
	{"DME_LINKSTARTUP_CNF_RESULT",		(0x7854)},
	{"DME_HIBERNATE_ENTER_CNF_RESULT",		(0x7864)},
	{"DME_HIBERNATE_ENTER_IND_RESULT",		(0x7868)},
	{"DME_HIBERNATE_EXIT_CNF_RESULT",		(0x7874)},
	{"DME_HIBERNATE_EXIT_IND_RESULT",		(0x7878)},
	{"DME_POWERMODE_IND_RESULT",		(0x78EC)},
	{"DME_INTR_STATUS_LSB",		(0x7B00)},
	{"DME_INTR_STATUS_MSB",		(0x7B04)},
	{"DME_INTR_ERROR_CODE",		(0x7B20)},
	{"DME_DBG_OPTION_SUITE",		(0x7C00)},
	{"DME_DBG_CTRL_FSM",		(0x7D00)},
	{"DME_DBG_FLAG_STATUS",		(0x7D14)},
	{"DME_DBG_LINKCFG_FSM",		(0x7D18)},
	{"DME_DBG_ERROR_HISTORY_COUNTER",		(0x7E10)},
	{"DME_DBG_ERROR_HISTORY_POINTER",		(0x7E14)},
	{"DME_DBG_ERROR_HISTORY_0",		(0x7E20)},
	{"DME_DBG_ERROR_HISTORY_1",		(0x7E24)},
	{"DME_DBG_ERROR_HISTORY_2",		(0x7E28)},
	{"DME_DBG_ERROR_HISTORY_3",		(0x7E2C)},
	{"DME_DBG_ERROR_HISTORY_4",		(0x7E30)},
	{"DME_DBG_ERROR_HISTORY_5",		(0x7E34)},
	{"DME_DBG_ERROR_HISTORY_6",		(0x7E38)},
	{"DME_DBG_ERROR_HISTORY_7",		(0x7E3C)},
			...
			*pval = unipro_readl(handle, PCS_CMN_OFFSET(cfg->mib));
			...
			for (i = 0 ; i < ATTR_NUM_MAX_LANES ; i++) {
				if (i >= mgr->lanes)
					...
					unipro_writel(handle, __WSTRB | __SEL_IDX(TX_LANE_0 + i), UNIP_COMP_AXI_AUX_FIELD);
					val = unipro_readl(handle, PCS_TRSV_OFFSET(cfg->mib));
				}
				*(pval + 1) = val;
			}
			...
			for (i = 0 ; i < ATTR_NUM_MAX_LANES ; i++) {
				if (i >= mgr->lanes)
					...
					unipro_writel(handle, __WSTRB | __SEL_IDX(RX_LANE_0 + i), UNIP_COMP_AXI_AUX_FIELD);
					val = unipro_readl(handle, PCS_TRSV_OFFSET(cfg->mib));
				}
				*(pval + 1) = val;
			}
...
static void __ufs_print_cport(struct ufs_dbg_mgr *mgr, struct device *dev)
{
	...
	while (cur_ptr < CPORT_BUF_SIZE) {
		...
		if (cur_ptr == CPORT_LOG_PTR_OFFSET) {
			...
			__print_cport(dev, tag_printed, tag, (u32 *)buf_ptr_out);
			buf_ptr_out += 0x10;
			cur_ptr += 0x10;
		}
	}
