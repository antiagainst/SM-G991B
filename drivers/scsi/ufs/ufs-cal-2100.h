...
static const struct ufs_cal_phy_cfg init_cfg_card[] = {
	/* mib(just to monitor), sfr offset, value, .. */
	{0x0000, 0x9514, 0x00, PMD_ALL, UNIPRO_DBG_PRD, BRD_ALL},

	{0x200, 0x2800, 0x40, PMD_ALL, PHY_PCS_COMN, BRD_ALL},
	{0x12, 0x2048, 0x00, PMD_ALL, PHY_PCS_RX_PRD, BRD_ALL},
	{0xAA, 0x22A8, 0x00, PMD_ALL, PHY_PCS_TX_PRD, BRD_ALL},
	{0x5C, 0x2170, 0x38, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x0F, 0x203C, 0x0, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x65, 0x2194, 0x01, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x69, 0x21A4, 0x1, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x21, 0x2084, 0x0, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x22, 0x2088, 0x0, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x84, 0x2210, 0x1, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x04, 0x2010, 0x1, PMD_ALL, PHY_PCS_TX, BRD_ALL},
	{0x8F, 0x223C, 0x3E, PMD_ALL, PHY_PCS_TX, BRD_ALL},
	{0x200, 0x2800, 0x0, PMD_ALL, PHY_PCS_COMN, BRD_ALL},

	{0x9536, 0x38D8, 0x4E20, PMD_ALL, UNIPRO_DBG_MIB, BRD_ALL},
	{0x9564, 0x3990, 0x2e820183, PMD_ALL, UNIPRO_DBG_MIB, BRD_ALL},
	{0x155E, 0x3178, 0x0, PMD_ALL, UNIPRO_STD_MIB, BRD_ALL},
	{0x3000, 0x5000, 0x0, PMD_ALL, UNIPRO_STD_MIB, BRD_ALL},
	{0x3001, 0x5004, 0x1, PMD_ALL, UNIPRO_STD_MIB, BRD_ALL},
	{0x4021, 0x6084, 0x1, PMD_ALL, UNIPRO_STD_MIB, BRD_ALL},
	...
	{0x0000, 0x8C, 0x80, PMD_ALL, PHY_PMA_COMN, BRD_ALL},

	{0x0000, 0x74, 0x10, PMD_ALL, PHY_PMA_COMN, BRD_ALL ^ BRD_ZEBU},
	...
	{0x0000, 0xE0, 0x24, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},

	{0x0000, 0x164, 0x58, PMD_ALL, PHY_PMA_TRSV, BRD_ALL},

	{0x0000, 0x8C, 0xC0, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
	{0x0000, 0x8C, 0x00, PMD_ALL, PHY_PMA_COMN, BRD_ALL},
...
static struct ufs_cal_phy_cfg post_init_cfg_card[] = {
	/* mib(just to monitor), sfr offset, value, .. */
	{0x9529, 0x3A84, 0x1, PMD_ALL, UNIPRO_DBG_MIB, BRD_ALL},
	{0x15A4, 0x3290, 0xFA, PMD_ALL, UNIPRO_STD_MIB, BRD_ALL},
	{0x9529, 0x3A84, 0x0, PMD_ALL, UNIPRO_DBG_MIB, BRD_ALL},
	{0x200, 0x2800, 0x40, PMD_ALL, PHY_PCS_COMN, BRD_ALL},
	{0x35, 0x20D4, 0x05, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x73, 0x21CC, 0x01, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x41, 0x2104, 0x02, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x42, 0x2108, 0xAC, PMD_ALL, PHY_PCS_RX, BRD_ALL},
	{0x200, 0x2800, 0x0, PMD_ALL, PHY_PCS_COMN, BRD_ALL},
...
static struct ufs_cal_phy_cfg calib_of_pwm_card[] = {
	...
	{0x0000, 0xC8, 0x40, PMD_PWM, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xF0, 0x77, PMD_PWM, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x120, 0x80, PMD_PWM, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x128, 0x00, PMD_PWM, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x12C, 0x00, PMD_PWM, PHY_PMA_TRSV, BRD_ALL},
...
static struct ufs_cal_phy_cfg calib_of_hs_rate_a_card[] = {
	...
	{0x0000, 0xC8, 0xBC, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0xF0, 0x7F, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x120, 0xC0, PMD_HS, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x128, 0x08, PMD_HS_G1, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x128, 0x02, PMD_HS_G2, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x128, 0x00, PMD_HS_G3, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x12C, 0x10, PMD_HS_G1, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x12C, 0x10, PMD_HS_G3, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x12C, 0x00, PMD_HS_G2, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x134, 0xE3, PMD_HS_G1, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x134, 0x73, PMD_HS_G2, PHY_PMA_TRSV, BRD_ALL},
	{0x0000, 0x134, 0x63, PMD_HS_G3, PHY_PMA_TRSV, BRD_ALL},
...
static struct ufs_cal_phy_cfg post_calib_of_hs_rate_a_card[] = {
	/* mib(just to monitor), sfr offset, value, .. */
	{0x0000, 0x1fc, 0x01, PMD_HS, PHY_CDR_WAIT, BRD_ZEBU},
	{0x0000, 0x1fc, 0x40, PMD_HS, PHY_CDR_AFC_WAIT, BRD_ALL ^ BRD_ZEBU},
...
static struct ufs_cal_phy_cfg pre_h8_exit_card[] = {
	...
	{0x0000, 0x00, 0x0A, PMD_HS, COMMON_WAIT, BRD_ALL},
