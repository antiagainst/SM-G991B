...
#define SBWC_10B_Y_HEADER_SIZE(w, h)	__ALIGN_UP((((__ALIGN_UP((w), 32) * __ALIGN_UP((h), 16) * \
					2) + 256) - SBWC_10B_Y_SIZE(w, h)), 32)
#define SBWC_10B_CBCR_SIZE(w, h)	((SBWC_10B_STRIDE(w) * (((__ALIGN_UP((h), 16) / 2) + 3) / 4)) + 64)
#define SBWC_10B_CBCR_HEADER_SIZE(w, h)	(((__ALIGN_UP((w), 32) * __ALIGN_UP((h), 16)) + 256) - \
					SBWC_10B_CBCR_SIZE(w, h))
