...
#include "camerapp-hw-reg-gdc-v210.h"
						...
						struct gdc_frame *d_frame, struct gdc_crop_param *crop_param)
{
	...
	gdc_output_offset_x = ALIGN((gdc_crop_width - gdc_output_width) >> 1, 2);
	gdc_output_offset_y = ALIGN((gdc_crop_height - gdc_output_height) >> 1, 2);
