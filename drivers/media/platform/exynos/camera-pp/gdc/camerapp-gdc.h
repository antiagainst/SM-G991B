...
#define gdc_pm_qos_add_request		pm_qos_add_request
#define gdc_pm_qos_update_request	pm_qos_update_request
#define gdc_pm_qos_remove_request	pm_qos_remove_request
#endif
