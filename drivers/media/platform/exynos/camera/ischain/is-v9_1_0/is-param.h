...
struct param_stripe_input {
	...
	u32	scaled_left_margin;	/* for ITSC SC */
	u32	scaled_right_margin;	/* for ITSC SC */
	u32	scaled_full_width;	/* for ITSC SC */
	u32	scaled_full_height;	/* for ITSC SC */
