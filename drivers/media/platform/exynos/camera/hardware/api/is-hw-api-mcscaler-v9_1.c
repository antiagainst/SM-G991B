...
#include "sfr/is-sfr-mcsc-v9_1.h"
#include "is-hw.h"
...
void is_scaler_set_poly_scaler_h_coef(void __iomem *base_addr, u32 output_id, struct scaler_filter_h_coef_cfg *h_coef_cfg)
{
	...
	case MCSC_OUTPUT3:
		for (index = 0; index <= 8; index++) {
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_H_COEFF_0A + (8 * index)], h_coef_cfg->h_coef_a[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_H_COEFF_0B + (8 * index)], h_coef_cfg->h_coef_b[index]);
			is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_H_COEFF_0AB + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_H_COEFF_0C + (8 * index)], h_coef_cfg->h_coef_c[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_H_COEFF_0D + (8 * index)], h_coef_cfg->h_coef_d[index]);
			is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_H_COEFF_0CD + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_H_COEFF_0E + (8 * index)], h_coef_cfg->h_coef_e[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_H_COEFF_0F + (8 * index)], h_coef_cfg->h_coef_f[index]);
			is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_H_COEFF_0EF + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_H_COEFF_0G + (8 * index)], h_coef_cfg->h_coef_g[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_H_COEFF_0H + (8 * index)], h_coef_cfg->h_coef_h[index]);
	...
	case MCSC_OUTPUT4:
		for (index = 0; index <= 8; index++) {
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_H_COEFF_0A + (8 * index)], h_coef_cfg->h_coef_a[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_H_COEFF_0B + (8 * index)], h_coef_cfg->h_coef_b[index]);
			is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_H_COEFF_0AB + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_H_COEFF_0C + (8 * index)], h_coef_cfg->h_coef_c[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_H_COEFF_0D + (8 * index)], h_coef_cfg->h_coef_d[index]);
			is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_H_COEFF_0CD + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_H_COEFF_0E + (8 * index)], h_coef_cfg->h_coef_e[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_H_COEFF_0F + (8 * index)], h_coef_cfg->h_coef_f[index]);
			is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_H_COEFF_0EF + (4 * index)], reg_val);
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_H_COEFF_0G + (8 * index)], h_coef_cfg->h_coef_g[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_H_COEFF_0H + (8 * index)], h_coef_cfg->h_coef_h[index]);
...
void is_scaler_set_poly_scaler_v_coef(void __iomem *base_addr, u32 output_id, struct scaler_filter_v_coef_cfg *v_coef_cfg)
{
	...
	case MCSC_OUTPUT3:
		for (index = 0; index <= 8; index++) {
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_V_COEFF_0A + (4 * index)], v_coef_cfg->v_coef_a[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_V_COEFF_0B + (4 * index)], v_coef_cfg->v_coef_b[index]);
			is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC3_V_COEFF_0AB + (2 * index)], reg_val);
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_V_COEFF_0C + (4 * index)], v_coef_cfg->v_coef_c[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC3_V_COEFF_0D + (4 * index)], v_coef_cfg->v_coef_d[index]);
	...
	case MCSC_OUTPUT4:
		for (index = 0; index <= 8; index++) {
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_V_COEFF_0A + (4 * index)], v_coef_cfg->v_coef_a[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_V_COEFF_0B + (4 * index)], v_coef_cfg->v_coef_b[index]);
			is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC4_V_COEFF_0AB + (2 * index)], reg_val);
			reg_val = 0;
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_V_COEFF_0C + (4 * index)], v_coef_cfg->v_coef_c[index]);
			reg_val = is_hw_set_field_value(reg_val,
				&mcsc_fields[MCSC_F_SC4_V_COEFF_0D + (4 * index)], v_coef_cfg->v_coef_d[index]);
...
{
	is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_SC2_CTRL], &mcsc_fields[MCSC_F_SC2_ENABLE], enable);
	/* if DJAG0_HF_SC_ENABLE == 1, Post-scaler_2, conv420_2, bchs_2, wdma_2 set to disable */
	if (enable) {
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_SC2_CTRL], &mcsc_fields[MCSC_F_SC2_OUT_CROP_ENABLE], 0);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_PC2_CTRL], &mcsc_fields[MCSC_F_PC2_ENABLE], 0);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_PC2_CONV420_CTRL],
			&mcsc_fields[MCSC_F_PC2_CONV420_ENABLE], 0);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_PC2_BCHS_CTRL],
			&mcsc_fields[MCSC_F_PC2_BCHS_ENABLE], 0);
		is_hw_set_field(base_addr, &mcsc_regs[MCSC_R_WDMA2_ENABLE],
			&mcsc_fields[MCSC_F_WDMA2_EN], 0);
	}
}
...
{
	u32 reg_val = 0;
	/* horizontal scaler for HF component share with POLY_2 */
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC2_SRC_HPOS], pos_x);
	reg_val = is_hw_set_field_value(reg_val, &mcsc_fields[MCSC_F_SC2_SRC_VPOS], pos_y);
	is_hw_set_reg(base_addr, &mcsc_regs[MCSC_R_SC2_SRC_POS], reg_val);
...
{
	/* horizontal scaler for HF component share with POLY_2 */
	is_scaler_set_poly_scaler_coef(base_addr, MCSC_OUTPUT2, hratio, vratio,
	...
	struct scaler_coef_cfg *sc_coef, enum exynos_sensor_position sensor_position)
{
	...
	u32 enable_poly2 = is_hw_get_field(base_addr,
						&mcsc_regs[MCSC_R_SC2_CTRL], &mcsc_fields[MCSC_F_SC2_ENABLE]);
	...
	if (hf_scaler_enable && enable_poly2) {
		err_hw("high frequency: hf scaler shared with port(%d), cannot be used at the same time!!",
				MCSC_OUTPUT2);
		is_scaler_set_rdma_enable(base_addr, hw_id, false);
		is_scaler_set_djag_hf_enable(base_addr, false, false);
		return -EINVAL;
