...
#define mdbgv_lvn(level, fmt, object, video, args...) \
	mdbg_common((debug_lvn) >= (level), "[%d][V%02d]", fmt, object->instance, video->id, ##args)
...
#define mlvdbgs(level, fmt, object, vid, args...) \
	mdbg_common((debug_stream) >= (level), "[%d][%s]", fmt, object->instance, vn_name[vid], ##args)
/*
 * =================================================================================================
 * LOG - PROBE
 * =================================================================================================
