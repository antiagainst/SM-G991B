		...
		u32 width, u32 height, u32 pix_stride)
{
	...
	case DMA_INOUT_FORMAT_BAYER_PACKED:
		if (bitwidth == DMA_INOUT_BIT_WIDTH_10BIT)
			dma_format = PAFSTAT_RDMA_FORMAT_10BIT_PACK;
		else if (bitwidth == DMA_INOUT_BIT_WIDTH_12BIT)
	...
	case PAFSTAT_RDMA_FORMAT_8BIT_PACK:
		stride_size = round_up(pix_stride, DMA_INOUT_BIT_WIDTH_16BIT);
		break;
	case PAFSTAT_RDMA_FORMAT_10BIT_PACK:
	case PAFSTAT_RDMA_FORMAT_ANDROID10:
		stride_size = round_up((pix_stride * 5 / 4), DMA_INOUT_BIT_WIDTH_16BIT);
		break;
	case PAFSTAT_RDMA_FORMAT_12BIT_PACK_LSB_ALIGN:
	case PAFSTAT_RDMA_FORMAT_12BIT_PACK_MSB_ALIGN:
		stride_size = round_up((pix_stride * 3 / 2), DMA_INOUT_BIT_WIDTH_16BIT);
		break;
	case PAFSTAT_RDMA_FORMAT_16BIT_PACK_LSB_ALIGN:
		stride_size = round_up((pix_stride * 2), DMA_INOUT_BIT_WIDTH_16BIT);
		break;
	default:
		stride_size = round_up(pix_stride, DMA_INOUT_BIT_WIDTH_16BIT);
		break;
