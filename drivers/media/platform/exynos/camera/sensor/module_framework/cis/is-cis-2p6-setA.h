...
const struct sensor_pll_info_compact sensor_2p6_pllinfo_A_4608x3456_30fps = {
	...
	1443 * 1000 * 1000ULL, /* mipi_datarate */
	560440000ULL,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
...
const struct sensor_pll_info_compact sensor_2p6_pllinfo_A_2304x1728_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1352 * 1000 * 1000ULL, /* mipi_datarate */
	560440000ULL,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
	0x0E1A, /* frame_length_lines	(0x0340) */
	0x1428, /* line_length_pck		(0x0342) */
};
...
const struct sensor_pll_info_compact sensor_2p6_pllinfo_A_1152x864_120fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1352 * 1000 * 1000ULL, /* mipi_datarate */
	572000000ULL,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
