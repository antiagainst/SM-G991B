	...
	const struct i2c_device_id *id)
{
	...
	if (strcmp(setfile, "default") == 0 ||
		...
		sensor_2l4_load_sram_size = sensor_2l4_setfile_B_sizes_load_sram;
#endif
		cis->mipi_sensor_mode = sensor_2l4_setfile_B_mipi_sensor_mode;
		cis->mipi_sensor_mode_size = ARRAY_SIZE(sensor_2l4_setfile_B_mipi_sensor_mode);
		verify_sensor_mode = sensor_2l4_setfile_B_verify_sensor_mode;
		verify_sensor_mode_size = ARRAY_SIZE(sensor_2l4_setfile_B_verify_sensor_mode);
	} else {
