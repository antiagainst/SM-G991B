...
#define IDMA_SPLIT_8K_LR(_v)			(1 << (_v))
#define IDMA_SPLIT_8K_LR_MASK			(1 << 1)
...
#define IDMA_VOTF_SLV_IDX(_v)		((_v) << 4)
#define IDMA_VOTF_SLV_IDX_MASK		(0xF << 4)
#define IDMA_VOTF_EN				(3 << 0)
#define IDMA_VOTF_SLV_MODE_EN		0x02
...
#define ODMA_VOTF_EN				(1 << 0)

/*
 *-------------------------------------------------------------------
 * DPU C2SERV Global(vOTF) SFR list
 *-------------------------------------------------------------------
 */
#define VOTF_RING_CLK_ENABLE		0x000C
#define VOTF_RING_CLK_EN			(1 << 0)

#define VOTF_RING_ENABLE			0x0010
#define VOTF_RING_EN				(1 << 0)

#define VOTF_LOCAL_IP				0x0014
#define VOTF_LOCAL_IP_ADDR			(0xFFFF << 0)

#define VOTF_SEL_REGISTER			0x0024
#define VOTF_SEL_REG				(0x1 << 0)

#define VOTF_REGISTER_MODE			0x0028
#define VOTF_SEL_REG_MODE			(0x1 << 0)

#define VOTF_OFFSET_0_4(_id)		(0x0300 + (_id) * 0x2C)
#define VOTF_OFFSET_5_8(_id)		(0x0400 + (_id) * 0x2C)

#define VOTF_TRS_ENABLE				0x0000
#define VOTF_TRS_EN					(1 << 0)

#define VOTF_CON_LOST_RECOVER_CONFIG	0x0004
#define VOTF_CON_LOST_FLUSH_EN			(1 << 1)
#define VOTF_CON_LOST_RECOVER_EN		(1 << 0)

#define VOTF_TRS_LIMIT				0x0008
#define VOTF_TRS_LIMIT_NUM			(0xFF << 0)

#define VOTF_TOKEN_CROP_START		0x000C
#define VOTF_CROP_START				(0xFFF << 0)

#define VOTF_CROP_ENABLE			0x0010
#define VOTF_CROP_EN				(0x1 << 0)

#define VOTF_LINE_IN_FIRST_TOKEN	0x0014
#define VOTF_FIRST_TOKEN			(0xFF << 0)

#define VOTF_LINE_IN_TOKEN			0x0018
#define VOTF_LINE_TOKEN				(0xFF << 0)

#define VOTF_LINE_COUNT				0x001C
