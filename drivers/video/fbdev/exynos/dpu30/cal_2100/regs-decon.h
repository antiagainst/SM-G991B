...
#define SEL_DSCC2				(3 << 8)
#define SEL_DSCC1				(3 << 4)
...
#define CWB_OUTFIFO0				(0x0)
#define CWB_OUTFIFO1				(0x1)
#define CWB_OUTFIFO3				(0x3)
#define CWB_PATH_F(_v)				((_v) << 20)
#define CWB_PATH_MASK				(0x3 << 20)
#define CWB_PATH_GET(_v)			(((_v) >> 20) & 0x3)

#define NOCOMP_DPIF				(1 << 3)
#define DPIF_MASK				(1 << 3)
