...
#define GFMUX_STATUS_DERIVED_TXCLK		(0x03 << 12)
#define GFMUX_STATUS_TXCLK_10			(0x03 << 10)
...
#define PCS_SERDES_FIFO_READ_START_VALUE	(0x311C)
#define READ_START_VALUE_SERDES_FIFO		(0xF << 0)

#define PCS_SERDES_FIFO_STATUS			(0x3120)
#define SERDES_FIFO_OVER_FLOW			(0x1 << 1)
#define SERDES_FIFO_UNDER_FLOW			(0x1 << 0)
...
#define INT_FAIL_SAFE_TRIGGER			(0x01 << 10)
...
#define FAIL_SAFE_TRIGGER_MASK			(0x01 << 10)
...
#define SEC_CRC_PASS				(0x01 << 5)
#define SEC_CRC_FAIL				(0x01 << 4)
#define SEC_CRC_FAIL_MASK			(0x01 << 3)
#define CLEAR_SEC_CRC_LFSR			(0x01 << 2)
#define SEC_CRC_CLEAR				(0x01 << 1)
#define SEC_CRC_ENABLE				(0x01 << 0)

#define SST1_MIN_BLANKING_DUMMY_COUNT		(0x5510)
#define MIN_BLANKING_DUMMY_COUNT		(0x3FFF << 0)

#define SST1_DSC_CRC_CONTROL_1			(0x5514)
#define CLEAR_DSC_CRC_LFSR			(0x01 << 1)
#define DSC_CRC_ENABLE				(0x01 << 0)

#define SST1_DSC_CRC_CONTROL_2			(0x5518)
#define DP_DSC_CRC_0				(0xFFFF << 0)

#define SST1_DSC_CRC_CONTROL_3			(0x551C)
#define DP_DSC_CRC_1				(0xFFFF << 0)

#define SST1_DSC_CRC_CONTROL_4			(0x5520)
#define DP_DSC_CRC_2				(0xFFFF << 0)
...
#define HDR10PLUS_INFO_UPDATE			(0x01 << 6)
#define ADAPTIVE_SYNC_INFO_UPDATE		(0x01 << 5)
...
#define HDR10PLUS_INFO_SEND			(0x01 << 6)
#define ADAPTIVE_SYNC_INFO_SEND			(0x01 << 5)
...
#define ADAPTIVE_SYNC_FEATURE_ENABLE			(0x01 << 0)
...
#define FAIL_SAFE_FEATURE_ENABLE			(0x01 << 16)
...
#define SST2_SEC_CRC_CONTROL_1			(0x6500)
#define SST2_SEC_CRC_CONTROL_2			(0x6504)
#define SST2_SEC_CRC_CONTROL_3			(0x6508)
#define SST2_SEC_CRC_CONTROL_4			(0x650C)
#define SST2_MIN_BLANKING_DUMMY_COUNT		(0x6510)
#define SST2_DSC_CRC_CONTROL_1			(0x6514)
#define SST2_DSC_CRC_CONTROL_2			(0x6518)
#define SST2_DSC_CRC_CONTROL_3			(0x651C)
#define SST2_DSC_CRC_CONTROL_4			(0x6520)
...
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_0	(0x6CC0)
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_1	(0x6CC4)
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_2	(0x6CC8)
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_3	(0x6CCC)
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_4	(0x6CD0)
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_5	(0x6CD4)
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_6	(0x6CD8)
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_7	(0x6CDC)
#define SST2_ADAPTIVE_SYNC_FEATURE_ENABLE		(0x6CE0)
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_HEADER_SET	(0x6CE4)
#define SST2_INFOFRAME_ADAPTIVE_SYNC_PACKET_PARITY_SET	(0x6CE8)
#define SST2_ADAPTIVE_SYNC_FAIL_SAFE_FEATURE		(0x6CEC)
...
#define SST2_INFOFRAME_HDRP10PLUS_PACKET_HEADER_SET	(0x6D84)
#define SST2_INFOFRAME_HDR10PLUS_PACKET_PARITY_SET	(0x6D88)
#define SST2_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_0	(0x6D8C)
#define SST2_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_1	(0x6D90)
#define SST2_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_2	(0x6D94)
#define SST2_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_3	(0x6D98)
#define SST2_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_4	(0x6D9C)
#define SST2_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_5	(0x6DA0)
#define SST2_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_6	(0x6DA4)
#define SST2_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_7	(0x6DA8)
...
#define ANA_ROPLL_ANA_VCI_SEL			(0x07 << 1)
...
#define CMN_REG00F2				(0x03C8)

#define CMN_REG0189				(0x0624)
#define DP_TX_CLK_INV_RBR			(0x0F << 4)

#define CMN_REG0194				(0x0650)
#define ANA_ROPLL_CLK_OUT_TO_EXT_IO_EN		(0x01 << 4)

#define CMN_REG00B1				(0x02C4)
#define ANA_ROPLL_RESERVED			(0xFF << 0)

#define CMN_REG00AC				(0x02B0)
#define ROPLL_MISC_CLK_DIV_RBR			(0x1F << 0)

#define CMN_REG00AD				(0x02B4)
#define ROPLL_MISC_CLK_DIV_HBR			(0x1F << 0)

#define CMN_REG00AE				(0x02B8)
#define ROPLL_MISC_CLK_DIV_HBR2			(0x1F << 0)

#define CMN_REG00AF				(0x02BC)
#define ROPLL_MISC_CLK_DIV_HBR3			(0x1F << 0)

#define CMN_REG0105				(0x0414)
#define DP_LINK_DIV10_CLK_OUT_SEL		(0x03 << 0)
...
#define LN1_TX_SER_40BIT_EN_SSP			(0x01 << 7)
#define LN1_TX_SER_40BIT_EN_HBR			(0x01 << 5)
#define LN1_TX_SER_RATE_SEL_SP			(0x01 << 0)
...
#define OVRD_LN3_TX_RXD_COMP_EN			(0x01 << 7)
#define OVRD_LN3_TX_RXD_EN			(0x01 << 5)
#define LN3_TX_SER_40BIT_EN_SP			(0x01 << 0)
#endif
