/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3fab/s6e3fab_unbound1_a3_s0_panel_hmd_dimming.h
 *
...
#ifndef __S6E3FAB_UNBOUND1_A3_S0_PANEL_HMD_DIMMING_H__
#define __S6E3FAB_UNBOUND1_A3_S0_PANEL_HMD_DIMMING_H__
#include "../dimming.h"
...
static unsigned int unbound1_a3_s0_hmd_brt_tbl[S6E3FAB_HMD_TOTAL_STEP] = {
...
static unsigned int unbound1_a3_s0_hmd_lum_tbl[S6E3FAB_HMD_TOTAL_STEP] = {
...
struct gm2_dimming_init_info s6e3fab_unbound1_a3_s0_gm2_hmd_dimming_init_info[] = {
	{
		.name = "s6e3fab_unbound1_a3_s0_gm2_hmd_dimming",
	},
};

static unsigned int unbound1_a3_s0_hmd_step_cnt_tbl[S6E3FAB_HMD_TOTAL_STEP] = {
	[0 ... S6E3FAB_HMD_TOTAL_STEP - 1] = 1,
};

static struct brightness_table s6e3fab_unbound1_a3_s0_panel_hmd_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = unbound1_a3_s0_hmd_brt_tbl,
	.sz_brt = ARRAY_SIZE(unbound1_a3_s0_hmd_brt_tbl),
	.sz_ui_brt = S6E3FAB_HMD_NR_STEP,
	.sz_hbm_brt = S6E3FAB_HMD_HBM_STEP,
	.lum = unbound1_a3_s0_hmd_lum_tbl,
	.sz_lum = ARRAY_SIZE(unbound1_a3_s0_hmd_lum_tbl),
	.sz_ui_lum = S6E3FAB_UNBOUND_HMD_NR_LUMINANCE,
	.sz_hbm_lum = 0,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = unbound1_a3_s0_hmd_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(unbound1_a3_s0_hmd_step_cnt_tbl),
};

static struct panel_dimming_info s6e3fab_unbound1_a3_s0_panel_hmd_dimming_info = {
	.name = "s6e3fab_unbound1_a3_s0_hmd",
	.dim_init_info = {
		NULL,
	},
	.gm2_dim_init_info = s6e3fab_unbound1_a3_s0_gm2_hmd_dimming_init_info,
	.nr_gm2_dim_init_info = ARRAY_SIZE(s6e3fab_unbound1_a3_s0_gm2_hmd_dimming_init_info),
	...
	.brt_tbl = &s6e3fab_unbound1_a3_s0_panel_hmd_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __S6E3FAB_UNBOUND1_A3_S0_PANEL_HMD_DIMMING_H__ */
