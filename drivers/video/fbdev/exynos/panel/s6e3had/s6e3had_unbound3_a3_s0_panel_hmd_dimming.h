/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3had/s6e3had_unbound3_a3_s0_panel_hmd_dimming.h
 *
...
#ifndef __S6E3HAD_UNBOUND3_A3_S0_PANEL_HMD_DIMMING_H__
#define __S6E3HAD_UNBOUND3_A3_S0_PANEL_HMD_DIMMING_H__
#include "../dimming.h"
#include "../panel_dimming.h"
#include "s6e3had_dimming.h"

#define S6E3HAD_HMD_NR_STEP (256)
#define S6E3HAD_HMD_HBM_STEP (0)
#define S6E3HAD_HMD_TOTAL_STEP (S6E3HAD_HMD_NR_STEP + S6E3HAD_HMD_HBM_STEP)

static unsigned int unbound3_a3_s0_hmd_brt_tbl[S6E3HAD_HMD_TOTAL_STEP] = {
...
static unsigned int unbound3_a3_s0_hmd_lum_tbl[S6E3HAD_HMD_TOTAL_STEP] = {
...
struct gm2_dimming_init_info s6e3had_unbound3_a3_s0_gm2_hmd_dimming_init_info[] = {
	{
		.name = "s6e3had_unbound3_a3_s0_gm2_hmd_dimming",
	},
};

static unsigned int unbound3_a3_s0_hmd_step_cnt_tbl[S6E3HAD_HMD_TOTAL_STEP] = {
	[0 ... S6E3HAD_HMD_TOTAL_STEP - 1] = 1,
};

static struct brightness_table s6e3had_unbound3_a3_s0_panel_hmd_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = unbound3_a3_s0_hmd_brt_tbl,
	.sz_brt = ARRAY_SIZE(unbound3_a3_s0_hmd_brt_tbl),
	.sz_ui_brt = S6E3HAD_HMD_NR_STEP,
	.sz_hbm_brt = S6E3HAD_HMD_HBM_STEP,
	.lum = unbound3_a3_s0_hmd_lum_tbl,
	.sz_lum = ARRAY_SIZE(unbound3_a3_s0_hmd_lum_tbl),
	.sz_ui_lum = S6E3HAD_UNBOUND3_HMD_NR_LUMINANCE,
	.sz_hbm_lum = 0,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = unbound3_a3_s0_hmd_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(unbound3_a3_s0_hmd_step_cnt_tbl),
};

static struct panel_dimming_info s6e3had_unbound3_a3_s0_panel_hmd_dimming_info = {
	.name = "s6e3had_unbound3_a3_s0_hmd",
	.dim_init_info = {
		NULL,
	},
	.gm2_dim_init_info = s6e3had_unbound3_a3_s0_gm2_hmd_dimming_init_info,
	.nr_gm2_dim_init_info = ARRAY_SIZE(s6e3had_unbound3_a3_s0_gm2_hmd_dimming_init_info),
	.target_luminance = S6E3HAD_UNBOUND3_HMD_TARGET_LUMINANCE,
	.nr_luminance = S6E3HAD_UNBOUND3_HMD_NR_LUMINANCE,
	.hbm_target_luminance = -1,
	.nr_hbm_luminance = 0,
	.extend_hbm_target_luminance = -1,
	.nr_extend_hbm_luminance = 0,
	.brt_tbl = &s6e3had_unbound3_a3_s0_panel_hmd_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,	/* read dim flash when probe or not */
};
#endif /* __S6E3HAD_UNBOUND3_A3_S0_PANEL_HMD_DIMMING_H__ */
