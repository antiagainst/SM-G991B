/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3had/s6e3had_aod.h
 *
...
#ifndef __S6E3HAD_AOD_H__
#define __S6E3HAD_AOD_H__
...
#define SELFMASK_CHECKSUM_VALID1 0x41
#define SELFMASK_CHECKSUM_VALID2 0x19
...
void s6e3had_copy_digital_blink(struct maptbl *tbl, u8 *dst);
...
//void s6e3had_copy_self_move_enable(struct maptbl *tbl, u8 *dst);
