...
extern int mdnie_remove(struct panel_device *panel);
...
static inline int mdnie_remove(struct panel_device *panel) { return 0; }
...
extern ssize_t attr_show_for_each(struct class *cls, const char *name, char *buf);
#endif /* __MDNIE_H__ */
