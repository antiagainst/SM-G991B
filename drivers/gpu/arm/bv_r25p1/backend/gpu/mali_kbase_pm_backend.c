...
static void kbase_pm_gpu_poweroff_wait_wq(struct work_struct *data)
{
	...
	/* MALI_SEC_INTEGRATION */
	KBASE_KTRACE_ADD_EXYNOS(kbdev, KBASE_DEVICE_PM_WAIT_WQ_RUN, NULL, NULL, \
		backend->poweron_required, 0);
...
void kbase_hwaccess_pm_suspend(struct kbase_device *kbdev)
{
	...
	/* MALI_SEC_INTEGRATION */
	KBASE_KTRACE_ADD_EXYNOS(kbdev, KBASE_DEVICE_PM_SUSPEND, NULL, NULL, 0u, 0u);
}
...
void kbase_hwaccess_pm_resume(struct kbase_device *kbdev)
{
	...
	/* MALI_SEC_INTEGRATION */
	KBASE_KTRACE_ADD_EXYNOS(kbdev, KBASE_DEVICE_PM_RESUME, NULL, NULL, 0u, 0u);
}
