...
static irqreturn_t kbase_job_irq_handler(int irq, void *data)
{
	...
	/* MALI_SEC_INTEGRAION */
	KBASE_KTRACE_ADD_EXYNOS(kbdev, LSI_JM_IRQ, NULL, NULL, 0, 0);
	...
	/* MALI_SEC_INTEGRAION */
	KBASE_KTRACE_ADD_EXYNOS(kbdev, LSI_JM_IRQ_E, NULL, NULL, 0, 0);
...
static irqreturn_t kbase_mmu_irq_handler(int irq, void *data)
{
	...
	/* MALI_SEC_INTEGRAION */
	KBASE_KTRACE_ADD_EXYNOS(kbdev, LSI_MMU_IRQ, NULL, NULL, 0, 0);
	...
	/* MALI_SEC_INTEGRAION */
	KBASE_KTRACE_ADD_EXYNOS(kbdev, LSI_MMU_IRQ_E, NULL, NULL, 0, 0);
...
static irqreturn_t kbase_gpu_irq_handler(int irq, void *data)
{
	...
	/* MALI_SEC_INTEGRAION */
	KBASE_KTRACE_ADD_EXYNOS(kbdev, LSI_GPU_IRQ, NULL, NULL, 0, 0);
	...
	/* MALI_SEC_INTEGRAION */
	KBASE_KTRACE_ADD_EXYNOS(kbdev, LSI_GPU_IRQ_E, NULL, NULL, 0, 0);
