...
extern void kbase_g3d_config_set_aruser(const struct kbase_device *kbdev, uint64_t val);
extern void kbase_g3d_config_set_awuser(const struct kbase_device *kbdev, uint64_t val);
#endif
