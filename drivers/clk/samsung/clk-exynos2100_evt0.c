...
#include <dt-bindings/clock/exynos2100_evt0.h>

#include "../../soc/samsung/cal-if/exynos2100_evt0/cmucal-vclk.h"
#include "../../soc/samsung/cal-if/exynos2100_evt0/cmucal-node.h"
#include "../../soc/samsung/cal-if/exynos2100_evt0/cmucal-qch.h"
#include "../../soc/samsung/cal-if/exynos2100_evt0/clkout_exynos2100.h"
#include "composite.h"
...
struct init_vclk exynos2100_alive_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_SYSREG_VGPIO2AP_QCH, SYSREG_VGPIO2AP_QCH, "GATE_SYSREG_VGPIO2AP_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSREG_VGPIO2APM_QCH, SYSREG_VGPIO2APM_QCH, "GATE_SYSREG_VGPIO2APM_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSREG_VGPIO2PMU_QCH, SYSREG_VGPIO2PMU_QCH, "GATE_SYSREG_VGPIO2PMU_QCH", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_csis_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_CSISX6_QCH_C2_CSIS, CSISX6_QCH_C2_CSIS, "GATE_CSISX6_QCH_C2_CSIS", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_CSISX6_QCH_CSIS_DMA, CSISX6_QCH_CSIS_DMA, "GATE_CSISX6_QCH_CSIS_DMA", "UMUX_CLKCMU_CSIS_CSIS", 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_QE_PDP_IMG2_QCH, QE_PDP_IMG2_QCH, "GATE_QE_PDP_IMG2_QCH", NULL, 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_QE_STRP23_QCH, QE_STRP23_QCH, "GATE_QE_STRP23_QCH", NULL, 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_QE_ZSL23_QCH, QE_ZSL23_QCH, "GATE_QE_ZSL23_QCH", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_dns_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_C2R_DNS_QCH, C2R_DNS_QCH, "GATE_C2R_DNS_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_DNS_QCH, DNS_QCH, "GATE_DNS_QCH", "UMUX_CLKCMU_DNS_BUS", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_DNS_QCH_C2COM, DNS_QCH_C2COM, "GATE_DNS_QCH_C2COM", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_dpuf0_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_C2A_DPUF0_0_QCH, C2A_DPUF0_0_QCH, "GATE_C2A_DPUF0_0_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_C2A_DPUF0_1_QCH, C2A_DPUF0_1_QCH, "GATE_C2A_DPUF0_1_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_C2R_DPUF0_DPUF1_QCH, C2R_DPUF0_DPUF1_QCH, "GATE_C2R_DPUF0_DPUF1_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_C2R_DPUF0_G2D_QCH, C2R_DPUF0_G2D_QCH, "GATE_C2R_DPUF0_G2D_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_C2R_DPUF0_M2M_QCH, C2R_DPUF0_M2M_QCH, "GATE_C2R_DPUF0_M2M_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_C2R_DPUF0_MCSC_QCH, C2R_DPUF0_MCSC_QCH, "GATE_C2R_DPUF0_MCSC_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_C2R_DPUF0_MFC0_QCH, C2R_DPUF0_MFC0_QCH, "GATE_C2R_DPUF0_MFC0_QCH", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_g2d_hwacg_vclks[] = {

	HWACG_VCLK(GATE_D_TZPC_G2D_QCH, D_TZPC_G2D_QCH, "GATE_D_TZPC_G2D_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_G2D_QCH, G2D_QCH, "GATE_G2D_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_G2D_CMU_G2D_QCH, G2D_CMU_G2D_QCH, "GATE_G2D_CMU_G2D_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_PPMU_D_G2D_QCH, PPMU_D_G2D_QCH, "GATE_PPMU_D_G2D_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSMMU_D_G2D_QCH_S1, SYSMMU_D_G2D_QCH_S1, "GATE_SYSMMU_D_G2D_QCH_S1", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSMMU_D_G2D_QCH_S2, SYSMMU_D_G2D_QCH_S2, "GATE_SYSMMU_D_G2D_QCH_S2", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSREG_G2D_QCH, SYSREG_G2D_QCH, "GATE_SYSREG_G2D_QCH", NULL, 0, VCLK_GATE, NULL),
};
...
struct init_vclk exynos2100_g3d_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_HTU_G3D_QCH, HTU_G3D_QCH, "GATE_HTU_G3D_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_RSTNSYNC_CLK_G3D_HTU_QCH, RSTNSYNC_CLK_G3D_HTU_QCH, "GATE_RSTNSYNC_CLK_G3D_HTU_QCH", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_hsi2_hwacg_vclks[] = {
        HWACG_VCLK(UMUX_CLKCMU_HSI2_BUS, MUX_CLKCMU_HSI2_BUS_USER, "UMUX_CLKCMU_HSI2_BUS", NULL, 0, 0, NULL),
        HWACG_VCLK(UMUX_CLKCMU_HSI2_MMC_CARD, MUX_CLKCMU_HSI2_MMC_CARD_USER, "UMUX_CLKCMU_HSI2_MMC_CARD", NULL, 0, 0, NULL),
        HWACG_VCLK(UMUX_CLKCMU_HSI2_UFS_CARD, MUX_CLKCMU_HSI2_UFS_CARD_USER, "UMUX_CLKCMU_HSI2_UFS_CARD", NULL, 0, 0, NULL),
        HWACG_VCLK(UMUX_CLKCMU_HSI2_UFS_EMBD, MUX_CLKCMU_HSI2_UFS_EMBD_USER, "UMUX_CLKCMU_HSI2_UFS_EMBD", NULL, 0, 0, NULL),

	HWACG_VCLK(GATE_D_TZPC_HSI2_QCH, D_TZPC_HSI2_QCH, "GATE_D_TZPC_HSI2_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_GPIO_HSI2_QCH, GPIO_HSI2_QCH, "GATE_GPIO_HSI2_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_HSI2_CMU_HSI2_QCH, HSI2_CMU_HSI2_QCH, "GATE_HSI2_CMU_HSI2_QCH", NULL, 0, VCLK_GATE, NULL),

	HWACG_VCLK(GATE_MMC_CARD_QCH, MMC_CARD_QCH, "GATE_MMC_CARD_QCH", "UMUX_CLKCMU_HSI2_MMC_CARD", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_PPMU_HSI2_QCH, PPMU_HSI2_QCH, "GATE_PPMU_HSI2_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSMMU_HSI2_QCH, SYSMMU_HSI2_QCH, "GATE_SYSMMU_HSI2_QCH", "UMUX_CLKCMU_HSI2_BUS", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSREG_HSI2_QCH, SYSREG_HSI2_QCH, "GATE_SYSREG_HSI2_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_UFS_CARD_QCH_FMP, UFS_CARD_QCH_FMP, "GATE_UFS_CARD_QCH_FMP", "UMUX_CLKCMU_HSI2_UFS_CARD", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_UFS_CARD_QCH, UFS_CARD_QCH, "GATE_UFS_CARD_QCH", "UMUX_CLKCMU_HSI2_UFS_CARD", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_UFS_EMBD_QCH_FMP, UFS_EMBD_QCH_FMP, "GATE_UFS_EMBD_QCH_FMP", "UMUX_CLKCMU_HSI2_UFS_EMBD", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_UFS_EMBD_QCH, UFS_EMBD_QCH, "GATE_UFS_EMBD_QCH", "UMUX_CLKCMU_HSI2_UFS_EMBD", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_VGEN_LITE_HSI2_QCH, VGEN_LITE_HSI2_QCH, "GATE_VGEN_LITE_HSI2_QCH", NULL, 0, VCLK_GATE, NULL),
};
...
struct init_vclk exynos2100_mcfp1_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_ORBMCH_QCH_C2, ORBMCH_QCH_C2, "GATE_ORBMCH_QCH_C2", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_ORBMCH_QCH, ORBMCH_QCH, "GATE_ORBMCH_QCH", "UMUX_CLKCMU_MCFP1_ORBMCH", 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_VGEN_LITE_MCFP1_QCH, VGEN_LITE_MCFP1_QCH, "GATE_VGEN_LITE_MCFP1_QCH", NULL, 0, VCLK_GATE, NULL),
};
...
struct init_vclk exynos2100_mcsc_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_C2R_DPUF_MCSC_QCH, C2R_DPUF_MCSC_QCH, "GATE_C2R_DPUF_MCSC_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_C2R_NPUS_MCSC_QCH, C2R_NPUS_MCSC_QCH, "GATE_C2R_NPUS_MCSC_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_C2R_VPC_MCSC_QCH, C2R_VPC_MCSC_QCH, "GATE_C2R_VPC_MCSC_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_D_TZPC_MCSC_QCH, D_TZPC_MCSC_QCH, "GATE_D_TZPC_MCSC_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_GDC0_QCH, GDC0_QCH, "GATE_GDC0_QCH", "UMUX_CLKCMU_MCSC_GDC", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_GDC0_QCH_C2, GDC0_QCH_C2, "GATE_GDC0_QCH_C2", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_GDC1_QCH, GDC1_QCH, "GATE_GDC1_QCH", "UMUX_CLKCMU_MCSC_GDC", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_GDC1_QCH_C2, GDC1_QCH_C2, "GATE_GDC1_QCH_C2", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_npus_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_HTU_NPUS_QCH, HTU_NPUS_QCH, "GATE_HTU_NPUS_QCH", NULL, 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_IP_NPUS_QCH_C2RISPCLK, IP_NPUS_QCH_C2RISPCLK, "GATE_IP_NPUS_QCH_C2RISPCLK", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_IP_NPUS_QCH_C2RVPUCLK, IP_NPUS_QCH_C2RVPUCLK, "GATE_IP_NPUS_QCH_C2RVPUCLK", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_IP_NPUS_QCH_C2RABOXCLK, IP_NPUS_QCH_C2RABOXCLK, "GATE_IP_NPUS_QCH_C2RABOXCLK", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_taa_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_C2R_TAA0_QCH, C2R_TAA0_QCH, "GATE_C2R_TAA0_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_C2R_TAA1_QCH, C2R_TAA1_QCH, "GATE_C2R_TAA1_QCH", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_vpc_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_HTU_VPC_QCH, HTU_VPC_QCH, "GATE_HTU_VPC_QCH", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_vts_hwacg_vclks[] = {
	...
	HWACG_VCLK(GATE_INTMEM_CODE_QCH, INTMEM_CODE_QCH, "GATE_INTMEM_CODE_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_INTMEM_DATA_QCH, INTMEM_DATA_QCH, "GATE_INTMEM_DATA_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_INTMEM_PCM_QCH, INTMEM_PCM_QCH, "GATE_INTMEM_PCM_QCH", NULL, 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_SERIAL_LIF_DEBUG_US_QCH_ACLK, SERIAL_LIF_DEBUG_US_QCH_ACLK, "GATE_SERIAL_LIF_DEBUG_US_QCH_ACLK", NULL, 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_SERIAL_LIF_DEBUG_VT_QCH_ACLK, SERIAL_LIF_DEBUG_VT_QCH_ACLK, "GATE_SERIAL_LIF_DEBUG_VT_QCH_ACLK", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos2100_hsi2_vclks[] = {
	VCLK(DOUT_CLKCMU_HSI2_MMC_CARD, CLKCMU_HSI2_MMC_CARD, "DOUT_CLKCMU_HSI2_MMC_CARD", 0, 0, NULL),
	VCLK(UFS_EMBD, CLKCMU_HSI2_UFS_EMBD, "UFS_EMBD", 0, 0, NULL),
};
...
struct init_vclk exynos2100_peric1_vclks[] = {
	...
	VCLK(DOUT_DIV_CLK_PERIC1_USI09_USI, DIV_CLK_PERIC1_USI09_USI, "DOUT_DIV_CLK_PERIC1_USI09_USI", 0, 0, NULL),
	VCLK(DOUT_DIV_CLK_PERIC1_USI10_USI, DIV_CLK_PERIC1_USI10_USI, "DOUT_DIV_CLK_PERIC1_USI10_USI", 0, 0, NULL),
...
static int exynos2100_clock_probe(struct platform_device *pdev)
{
	...
	samsung_register_vclk(exynos2100_clk_provider, exynos2100_g2d_hwacg_vclks, ARRAY_SIZE(exynos2100_g2d_hwacg_vclks));
	...
	samsung_register_vclk(exynos2100_clk_provider, exynos2100_hsi2_hwacg_vclks, ARRAY_SIZE(exynos2100_hsi2_hwacg_vclks));
	...
	samsung_register_vclk(exynos2100_clk_provider, exynos2100_hsi2_vclks, ARRAY_SIZE(exynos2100_hsi2_vclks));
