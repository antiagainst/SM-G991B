...
#define URGENT_FIRMWARE_PATH "sensorhub/urgent.patch"
#define URGENT_FIRMWARE_TEST_PATH "test/sensorhub/urgent.patch"
...
extern int request_firmware_update(const char *path, const struct firmware **fw_entry);
#endif /* __BBD_H__ */
