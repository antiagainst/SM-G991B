...
void report_light_seamless_data(struct ssp_data *data, int sensor_type,
		struct sensor_value *light_seamless_data)
{
	report_iio_data(data, LIGHT_SEAMLESS_SENSOR, light_seamless_data);
	wake_lock_timeout(data->ssp_wake_lock, 0.3*HZ);
