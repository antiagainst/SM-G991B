...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU0_INT_EN", 0x15860000, 0x1044, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU0_INT_EN", 0x15860000, 0x1044, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU1_INT_EN", 0x15860000, 0x10c4, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU1_INT_EN", 0x15860000, 0x10c4, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU2_INT_EN", 0x15860000, 0x1144, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU2_INT_EN", 0x15860000, 0x1144, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU3_INT_EN", 0x15860000, 0x11c4, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU3_INT_EN", 0x15860000, 0x11c4, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU0_INT_EN", 0x15860000, 0x1344, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU0_INT_EN", 0x15860000, 0x1344, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU1_INT_EN", 0x15860000, 0x13c4, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU1_INT_EN", 0x15860000, 0x13c4, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU2_INT_EN", 0x15860000, 0x1444, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU2_INT_EN", 0x15860000, 0x1444, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER2_CPU0_INT_EN", 0x15860000, 0x1644, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
//	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER2_CPU0_INT_EN", 0x15860000, 0x1644, (0x1 << 3), (0x1 << 3), 0, 0, 0xffffffff, 0),  // for GKI. move to el3
};
...
struct pmucal_seq core00_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CORE", 0x1d040000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster0_cpu_up", 0, 0, 0x21, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CORE", 0x1d040000, 0x0860, (0x1 << 5), (0x0 << 5), 0, 0, 0, 0),
};
struct pmucal_seq core00_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CORE", 0x1d040000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0, 0),
...
struct pmucal_seq core10_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CORE", 0x1d050000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster1_cpu_up", 0, 0, 0x31, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CORE", 0x1d050000, 0x0860, (0x1 << 5), (0x0 << 5), 0, 0, 0, 0),
};
struct pmucal_seq core10_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CORE", 0x1d050000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0, 0),
...
struct pmucal_seq core20_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL2_HCHGEN_CLKMUX_CORE", 0x1d060000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster2_cpu_up", 0, 0, 0x41, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL2_HCHGEN_CLKMUX_CORE", 0x1d060000, 0x0860, (0x1 << 5), (0x0 << 5), 0, 0, 0, 0),
};
struct pmucal_seq core20_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL2_HCHGEN_CLKMUX_CORE", 0x1d060000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0, 0),
...
struct pmucal_seq cluster0_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "DSU_HCHGEN_CLKMUX_CLUSTER", 0x1d030000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster0_noncpu_up", 0, 0, 0x28, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "DSU_HCHGEN_CLKMUX_CLUSTER", 0x1d030000, 0x0860, (0x1 << 5), (0x0 << 5), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_STR_CPUCL0_0_QCH", 0x1d040000, 0x3014, (0x1 << 2), (0x1 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_STR_CPUCL0_1_QCH", 0x1d050000, 0x301c, (0x1 << 2), (0x1 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_STR_CPUCL0_2_QCH", 0x1d060000, 0x3014, (0x1 << 2), (0x1 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_STR_CPUCL0_3_QCH", 0x1d030000, 0x3040, (0x1 << 2), (0x1 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_ADD_CPUCL0_0_QCH", 0x1d040000, 0x3010, (0x1 << 2), (0x1 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_ADD_CPUCL0_1_QCH", 0x1d050000, 0x3018, (0x1 << 2), (0x1 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_ADD_CPUCL0_2_QCH", 0x1d060000, 0x3010, (0x1 << 2), (0x1 << 2), 0, 0, 0, 0),
};
struct pmucal_seq cluster0_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "STR_CTRL0", 0x1d190000, 0x0000, (0x1 << 0), (0x0 << 0), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "STR_CTRL0", 0x1d1a0000, 0x0000, (0x1 << 0), (0x0 << 0), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "STR_CTRL0", 0x1d1b0000, 0x0000, (0x1 << 0), (0x0 << 0), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "STR_CTRL0", 0x1d1c0000, 0x0000, (0x1 << 0), (0x0 << 0), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_STR_CPUCL0_0_QCH", 0x1d040000, 0x3014, (0x1 << 2), (0x0 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_STR_CPUCL0_1_QCH", 0x1d050000, 0x301c, (0x1 << 2), (0x0 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_STR_CPUCL0_2_QCH", 0x1d060000, 0x3014, (0x1 << 2), (0x0 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_STR_CPUCL0_3_QCH", 0x1d030000, 0x3040, (0x1 << 2), (0x0 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_ADD_CPUCL0_0_QCH", 0x1d040000, 0x3010, (0x1 << 2), (0x0 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_ADD_CPUCL0_1_QCH", 0x1d050000, 0x3018, (0x1 << 2), (0x0 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_BUSIF_ADD_CPUCL0_2_QCH", 0x1d060000, 0x3010, (0x1 << 2), (0x0 << 2), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "DSU_HCHGEN_CLKMUX_CLUSTER", 0x1d030000, 0x0860, (0x1 << 5), (0x1 << 5), 0, 0, 0, 0),
