...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_npusaud[] = {
	GOUT_BLK_AUD_UID_LHM_AST_VO_NPUSAUD_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhm_ast_vo_vpcaud[] = {
	GOUT_BLK_AUD_UID_LHM_AST_VO_VPCAUD_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_audnpus[] = {
	GOUT_BLK_AUD_UID_LHS_AST_VO_AUDNPUS_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_audvpc[] = {
...
enum clk_id cmucal_vclk_ip_qe_strp23[] = {
...
enum clk_id cmucal_vclk_ip_qe_zsl23[] = {
...
enum clk_id cmucal_vclk_ip_lhs_ast_vo_csistaa[] = {
...
enum clk_id cmucal_vclk_ip_qe_pdp_img2[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_taadns[] = {
...
enum clk_id cmucal_vclk_ip_lhs_ast_vo_dnsyuvpp[] = {
...
enum clk_id cmucal_vclk_ip_lhs_ast_vo_dnsmcsc[] = {
	GOUT_BLK_DNS_UID_LHS_AST_VO_DNSMCSC_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhm_ast_vo_yuvppdns[] = {
...
enum clk_id cmucal_vclk_ip_c2r_dns[] = {
...
enum clk_id cmucal_vclk_ip_lhs_ast_vo_dpuf1dpuf0[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_dpuf0dpuf1[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_dpuf0g2d[] = {
	GOUT_BLK_G2D_UID_LHM_AST_VO_DPUF0G2D_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_g2ddpuf0[] = {
...
enum clk_id cmucal_vclk_ip_vgen_lite_hsi2[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_taalme[] = {
	GOUT_BLK_LME_UID_LHM_AST_VO_TAALME_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_lmetaa[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_dpuf0m2m[] = {
	GOUT_BLK_M2M_UID_LHM_AST_VO_DPUF0M2M_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_m2mdpuf0[] = {
...
enum clk_id cmucal_vclk_ip_apb_async_mcfp0[] = {
...
enum clk_id cmucal_vclk_ip_lhs_axi_d_mcfp0mcfp1[] = {
...
enum clk_id cmucal_vclk_ip_ad_apb_mcfp1[] = {
...
enum clk_id cmucal_vclk_ip_vgen_lite_mcfp1[] = {
...
enum clk_id cmucal_vclk_ip_ad_apb_orbmch[] = {
...
enum clk_id cmucal_vclk_ip_lhm_axi_d_mcfp0mcfp1[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_dnsmcsc[] = {
	GOUT_BLK_MCSC_UID_LHM_AST_VO_DNSMCSC_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhm_ast_int_mcscgdc0[] = {
	GOUT_BLK_MCSC_UID_LHM_AST_INT_MCSCGDC0_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_int_mcscgdc0[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_dpuf0mcsc[] = {
	GOUT_BLK_MCSC_UID_LHM_AST_VO_DPUF0MCSC_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhm_ast_vo_npusmcsc[] = {
	GOUT_BLK_MCSC_UID_LHM_AST_VO_NPUSMCSC_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhm_ast_vo_vpcmcsc[] = {
	GOUT_BLK_MCSC_UID_LHM_AST_VO_VPCMCSC_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_mcscdpuf0[] = {
	GOUT_BLK_MCSC_UID_LHS_AST_VO_MCSCDPUF0_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_mcscnpus[] = {
	GOUT_BLK_MCSC_UID_LHS_AST_VO_MCSCNPUS_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_mcscvpc[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_dpuf0mfc0[] = {
	GOUT_BLK_MFC0_UID_LHM_AST_VO_DPUF0MFC0_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_mfc0dpuf0[] = {
...
enum clk_id cmucal_vclk_ip_lhs_axi_d0_npu11[] = {
...
enum clk_id cmucal_vclk_ip_lhs_axi_d_ctrl_npu11[] = {
...
enum clk_id cmucal_vclk_ip_lhm_axi_d_rq_npu11[] = {
...
enum clk_id cmucal_vclk_ip_lhm_axi_d_cmdq_npu11[] = {
...
enum clk_id cmucal_vclk_ip_lhs_axi_d1_npu11[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_audnpus[] = {
	GOUT_BLK_NPUS_UID_LHM_AST_VO_AUDNPUS_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhm_ast_vo_mcscnpus[] = {
	GOUT_BLK_NPUS_UID_LHM_AST_VO_MCSCNPUS_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhm_ast_vo_vpcnpus[] = {
	GOUT_BLK_NPUS_UID_LHM_AST_VO_VPCNPUS_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_npusaud[] = {
	GOUT_BLK_NPUS_UID_LHS_AST_VO_NPUSAUD_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_npusmcsc[] = {
	GOUT_BLK_NPUS_UID_LHS_AST_VO_NPUSMCSC_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_npusvpc[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_csistaa[] = {
	GOUT_BLK_TAA_UID_LHM_AST_VO_CSISTAA_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_taadns[] = {
...
enum clk_id cmucal_vclk_ip_c2r_taa0[] = {
...
enum clk_id cmucal_vclk_ip_c2r_taa1[] = {
	GOUT_BLK_TAA_UID_C2R_TAA1_IPCLKPORT_C2CLK,
};
enum clk_id cmucal_vclk_ip_lhm_ast_vo_lmetaa[] = {
	GOUT_BLK_TAA_UID_LHM_AST_VO_LMETAA_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_taalme[] = {
...
enum clk_id cmucal_vclk_ip_lhm_axi_d_vpd2vpc_cache[] = {
	GOUT_BLK_VPC_UID_LHM_AXI_D_VPD2VPC_CACHE_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhm_axi_d_vpd2vpc_sfr[] = {
...
enum clk_id cmucal_vclk_ip_lhs_axi_p_vpcvpd2[] = {
	GOUT_BLK_VPC_UID_LHS_AXI_P_VPCVPD2_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_axi_d_vpcvpd2_sfr[] = {
...
enum clk_id cmucal_vclk_ip_lhs_axi_d_vpcvpd2_dma[] = {
...
enum clk_id cmucal_vclk_ip_lhs_ace_d_vpdvpc_scc[] = {
	GOUT_BLK_VPD_UID_LHS_ACE_D_VPDVPC_SCC_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_xiu_dp_vts_20p5[] = {
...
enum clk_id cmucal_vclk_ip_ahb2axi_cm40[] = {
	GOUT_BLK_VTS_UID_AHB2AXI_CM40_IPCLKPORT_ACLK,
};
enum clk_id cmucal_vclk_ip_ahb2axi_cm41[] = {
	GOUT_BLK_VTS_UID_AHB2AXI_CM41_IPCLKPORT_ACLK,
};
enum clk_id cmucal_vclk_ip_ahb2axi_cm42[] = {
...
enum clk_id cmucal_vclk_ip_intmem_data[] = {
...
enum clk_id cmucal_vclk_ip_ahb2axi_ahb1[] = {
...
enum clk_id cmucal_vclk_ip_ahb2axi_ahb3[] = {
...
enum clk_id cmucal_vclk_ip_ahb2axi_ahb5[] = {
...
enum clk_id cmucal_vclk_ip_asyncaxi1[] = {
...
enum clk_id cmucal_vclk_ip_asyncaxi3[] = {
...
enum clk_id cmucal_vclk_ip_asyncaxi5[] = {
...
enum clk_id cmucal_vclk_ip_ad_apb_yuvpp[] = {
...
enum clk_id cmucal_vclk_ip_lhm_ast_vo_dnsyuvpp[] = {
	GOUT_BLK_YUVPP_UID_LHM_AST_VO_DNSYUVPP_IPCLKPORT_I_CLK,
};
enum clk_id cmucal_vclk_ip_lhs_ast_vo_yuvppdns[] = {
...
struct vclk_lut cmucal_vclk_vdd_cpucl2_lut[] = {
	{2500000, vdd_cpucl2_sod_lut_params},
	{2100000, vdd_cpucl2_od_lut_params},
	{1600000, vdd_cpucl2_nm_lut_params},
...
struct vclk_lut cmucal_vclk_vdd_cpucl0_lut[] = {
	{2200000, vdd_cpucl0_sod_lut_params},
...
struct vclk_lut cmucal_vclk_vdd_cpucl1_lut[] = {
	{2500000, vdd_cpucl1_sod_lut_params},
	{1950000, vdd_cpucl1_od_lut_params},
	{1500000, vdd_cpucl1_nm_lut_params},
	{950000, vdd_cpucl1_ud_lut_params},
	{550000, vdd_cpucl1_sud_lut_params},
	{300000, vdd_cpucl1_uud_lut_params},
};
struct vclk_lut cmucal_vclk_vdd_int_cmu_lut[] = {
	{860000, vdd_int_cmu_nm_lut_params},
	{860000, vdd_int_cmu_od_lut_params},
	{860000, vdd_int_cmu_sod_lut_params},
	{675000, vdd_int_cmu_ud_lut_params},
	{360000, vdd_int_cmu_sud_lut_params},
	{95000, vdd_int_cmu_uud_lut_params},
};
...
struct vclk_lut cmucal_vclk_mux_clk_aud_dsif_lut[] = {
	...
	{533000, mux_clk_aud_dsif_ud_lut_params},
	{50000, mux_clk_aud_dsif_od_lut_params},
	{50000, mux_clk_aud_dsif_uud_lut_params},
};
...
struct vclk_lut cmucal_vclk_clkcmu_g3d_shader_lut[] = {
	{860000, clkcmu_g3d_shader_sod_lut_params},
	{675000, clkcmu_g3d_shader_ud_lut_params},
	{360000, clkcmu_g3d_shader_sud_lut_params},
	{95000, clkcmu_g3d_shader_uud_lut_params},
};
...
struct vclk_lut cmucal_vclk_div_clk_cpucl0_shortstop_core_lut[] = {
	{1100000, div_clk_cpucl0_shortstop_core_sod_lut_params},
	{850000, div_clk_cpucl0_shortstop_core_od_lut_params},
	{600000, div_clk_cpucl0_shortstop_core_nm_lut_params},
	{400000, div_clk_cpucl0_shortstop_core_ud_lut_params},
	{240000, div_clk_cpucl0_shortstop_core_sud_lut_params},
	{87500, div_clk_cpucl0_shortstop_core_uud_lut_params},
};
struct vclk_lut cmucal_vclk_div_clk_cpucl1_shortstop_core_lut[] = {
	{1250000, div_clk_cpucl1_shortstop_core_sod_lut_params},
	{975000, div_clk_cpucl1_shortstop_core_od_lut_params},
	{750000, div_clk_cpucl1_shortstop_core_nm_lut_params},
	{475000, div_clk_cpucl1_shortstop_core_ud_lut_params},
	{275000, div_clk_cpucl1_shortstop_core_sud_lut_params},
	{150000, div_clk_cpucl1_shortstop_core_uud_lut_params},
};
struct vclk_lut cmucal_vclk_div_clk_cpucl1_htu_lut[] = {
	{625000, div_clk_cpucl1_htu_sod_lut_params},
	{487500, div_clk_cpucl1_htu_od_lut_params},
	{375000, div_clk_cpucl1_htu_nm_lut_params},
	{237500, div_clk_cpucl1_htu_ud_lut_params},
	{137500, div_clk_cpucl1_htu_sud_lut_params},
	{75000, div_clk_cpucl1_htu_uud_lut_params},
};
struct vclk_lut cmucal_vclk_div_clk_cpucl2_shortstop_core_lut[] = {
	{1250000, div_clk_cpucl2_shortstop_core_sod_lut_params},
	{1050000, div_clk_cpucl2_shortstop_core_od_lut_params},
	{800000, div_clk_cpucl2_shortstop_core_nm_lut_params},
	{500000, div_clk_cpucl2_shortstop_core_ud_lut_params},
	{300000, div_clk_cpucl2_shortstop_core_sud_lut_params},
	{150000, div_clk_cpucl2_shortstop_core_uud_lut_params},
};
struct vclk_lut cmucal_vclk_div_clk_cpucl2_htu_lut[] = {
	{625000, div_clk_cpucl2_htu_sod_lut_params},
	{525000, div_clk_cpucl2_htu_od_lut_params},
	{400000, div_clk_cpucl2_htu_nm_lut_params},
	{250000, div_clk_cpucl2_htu_ud_lut_params},
	{150000, div_clk_cpucl2_htu_sud_lut_params},
	{75000, div_clk_cpucl2_htu_uud_lut_params},
};
struct vclk_lut cmucal_vclk_div_clk_dsu_shortstop_cluster_lut[] = {
	{900000, div_clk_dsu_shortstop_cluster_sod_lut_params},
	{750000, div_clk_dsu_shortstop_cluster_od_lut_params},
	{550000, div_clk_dsu_shortstop_cluster_nm_lut_params},
	{357500, div_clk_dsu_shortstop_cluster_ud_lut_params},
	{210000, div_clk_dsu_shortstop_cluster_sud_lut_params},
	{87500, div_clk_dsu_shortstop_cluster_uud_lut_params},
};
...
struct vclk_lut cmucal_vclk_blk_cmu_lut[] = {
	...
	{1420000, blk_cmu_sud_lut_params},
...
struct vclk_lut cmucal_vclk_blk_cpucl0_lut[] = {
	{2200000, blk_cpucl0_sod_lut_params},
	{1700000, blk_cpucl0_od_lut_params},
	{1200000, blk_cpucl0_nm_lut_params},
	{800000, blk_cpucl0_ud_lut_params},
	{480000, blk_cpucl0_sud_lut_params},
	{175000, blk_cpucl0_uud_lut_params},
};
struct vclk_lut cmucal_vclk_blk_cpucl1_lut[] = {
	{2500000, blk_cpucl1_sod_lut_params},
	{1950000, blk_cpucl1_od_lut_params},
	{1500000, blk_cpucl1_nm_lut_params},
	{950000, blk_cpucl1_ud_lut_params},
	{550000, blk_cpucl1_sud_lut_params},
	{300000, blk_cpucl1_uud_lut_params},
};
struct vclk_lut cmucal_vclk_blk_cpucl2_lut[] = {
	{2500000, blk_cpucl2_sod_lut_params},
	{2100000, blk_cpucl2_od_lut_params},
	{1600000, blk_cpucl2_nm_lut_params},
...
struct vclk_lut cmucal_vclk_blk_dsu_lut[] = {
	{1100000, blk_dsu_nm_lut_params},
	{900000, blk_dsu_sod_lut_params},
	{750000, blk_dsu_od_lut_params},
	{715000, blk_dsu_ud_lut_params},
	{420000, blk_dsu_sud_lut_params},
	{175000, blk_dsu_uud_lut_params},
};
struct vclk_lut cmucal_vclk_blk_g3d_lut[] = {
	{215000, blk_g3d_nm_lut_params},
};
...
struct vclk_lut cmucal_vclk_blk_dpub_lut[] = {
	{165750, blk_dpub_nm_lut_params},
	{100000, blk_dpub_uud_lut_params},
};
struct vclk_lut cmucal_vclk_blk_dpuf0_lut[] = {
	{165750, blk_dpuf0_uud_lut_params},
};
struct vclk_lut cmucal_vclk_blk_dpuf1_lut[] = {
	{165750, blk_dpuf1_nm_lut_params},
};
struct vclk_lut cmucal_vclk_blk_g2d_lut[] = {
	{357500, blk_g2d_nm_lut_params},
};
...
/*================================ VCLK List =================================*/
unsigned int cmucal_vclk_size = 1270;
...
/* GATE VCLK*/
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_NPUSAUD, NULL, cmucal_vclk_ip_lhm_ast_vo_npusaud, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_VPCAUD, NULL, cmucal_vclk_ip_lhm_ast_vo_vpcaud, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_AUDNPUS, NULL, cmucal_vclk_ip_lhs_ast_vo_audnpus, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_AUDVPC, NULL, cmucal_vclk_ip_lhs_ast_vo_audvpc, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_QE_STRP23, NULL, cmucal_vclk_ip_qe_strp23, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_QE_ZSL1, NULL, cmucal_vclk_ip_qe_zsl1, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_QE_ZSL23, NULL, cmucal_vclk_ip_qe_zsl23, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_CSISTAA, NULL, cmucal_vclk_ip_lhs_ast_vo_csistaa, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_QE_PDP_IMG2, NULL, cmucal_vclk_ip_qe_pdp_img2, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_TAADNS, NULL, cmucal_vclk_ip_lhm_ast_vo_taadns, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_DNSYUVPP, NULL, cmucal_vclk_ip_lhs_ast_vo_dnsyuvpp, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_DNSMCSC, NULL, cmucal_vclk_ip_lhs_ast_vo_dnsmcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_YUVPPDNS, NULL, cmucal_vclk_ip_lhm_ast_vo_yuvppdns, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_VGEN_LITE_D1_DNS, NULL, cmucal_vclk_ip_vgen_lite_d1_dns, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2R_DNS, NULL, cmucal_vclk_ip_c2r_dns, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_G2DDPUF0, NULL, cmucal_vclk_ip_lhm_ast_vo_g2ddpuf0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_M2MDPUF0, NULL, cmucal_vclk_ip_lhm_ast_vo_m2mdpuf0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_DPUF0G2D, NULL, cmucal_vclk_ip_lhs_ast_vo_dpuf0g2d, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_DPUF0M2M, NULL, cmucal_vclk_ip_lhs_ast_vo_dpuf0m2m, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_DPUF1DPUF0, NULL, cmucal_vclk_ip_lhm_ast_vo_dpuf1dpuf0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_DPUF0DPUF1, NULL, cmucal_vclk_ip_lhs_ast_vo_dpuf0dpuf1, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_MCSCDPUF0, NULL, cmucal_vclk_ip_lhm_ast_vo_mcscdpuf0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_MFC0DPUF0, NULL, cmucal_vclk_ip_lhm_ast_vo_mfc0dpuf0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_DPUF0MCSC, NULL, cmucal_vclk_ip_lhs_ast_vo_dpuf0mcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_DPUF0MFC0, NULL, cmucal_vclk_ip_lhs_ast_vo_dpuf0mfc0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2A_DPUF0_0, NULL, cmucal_vclk_ip_c2a_dpuf0_0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2A_DPUF0_1, NULL, cmucal_vclk_ip_c2a_dpuf0_1, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2R_DPUF0_DPUF1, NULL, cmucal_vclk_ip_c2r_dpuf0_dpuf1, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2R_DPUF0_G2D, NULL, cmucal_vclk_ip_c2r_dpuf0_g2d, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2R_DPUF0_M2M, NULL, cmucal_vclk_ip_c2r_dpuf0_m2m, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2R_DPUF0_MCSC, NULL, cmucal_vclk_ip_c2r_dpuf0_mcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2R_DPUF0_MFC0, NULL, cmucal_vclk_ip_c2r_dpuf0_mfc0, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_DPUF1DPUF0, NULL, cmucal_vclk_ip_lhs_ast_vo_dpuf1dpuf0, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_DPUF0DPUF1, NULL, cmucal_vclk_ip_lhm_ast_vo_dpuf0dpuf1, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_PPMU_D_G2D, NULL, cmucal_vclk_ip_ppmu_d_g2d, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_SYSMMU_D_G2D, NULL, cmucal_vclk_ip_sysmmu_d_g2d, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_DPUF0G2D, NULL, cmucal_vclk_ip_lhm_ast_vo_dpuf0g2d, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_G2DDPUF0, NULL, cmucal_vclk_ip_lhs_ast_vo_g2ddpuf0, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_VGEN_LITE_HSI2, NULL, cmucal_vclk_ip_vgen_lite_hsi2, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_TAALME, NULL, cmucal_vclk_ip_lhm_ast_vo_taalme, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_LMETAA, NULL, cmucal_vclk_ip_lhs_ast_vo_lmetaa, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_DPUF0M2M, NULL, cmucal_vclk_ip_lhm_ast_vo_dpuf0m2m, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_M2MDPUF0, NULL, cmucal_vclk_ip_lhs_ast_vo_m2mdpuf0, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_APB_ASYNC_MCFP0, NULL, cmucal_vclk_ip_apb_async_mcfp0, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_AXI_D_MCFP0MCFP1, NULL, cmucal_vclk_ip_lhs_axi_d_mcfp0mcfp1, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_AD_APB_MCFP1, NULL, cmucal_vclk_ip_ad_apb_mcfp1, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_QE_D2_ORBMCH, NULL, cmucal_vclk_ip_qe_d2_orbmch, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_VGEN_LITE_MCFP1, NULL, cmucal_vclk_ip_vgen_lite_mcfp1, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_AD_APB_ORBMCH, NULL, cmucal_vclk_ip_ad_apb_orbmch, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AXI_D_MCFP0MCFP1, NULL, cmucal_vclk_ip_lhm_axi_d_mcfp0mcfp1, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_DNSMCSC, NULL, cmucal_vclk_ip_lhm_ast_vo_dnsmcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_INT_MCSCGDC0, NULL, cmucal_vclk_ip_lhm_ast_int_mcscgdc0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_INT_MCSCGDC0, NULL, cmucal_vclk_ip_lhs_ast_int_mcscgdc0, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_DPUF0MCSC, NULL, cmucal_vclk_ip_lhm_ast_vo_dpuf0mcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_NPUSMCSC, NULL, cmucal_vclk_ip_lhm_ast_vo_npusmcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_VPCMCSC, NULL, cmucal_vclk_ip_lhm_ast_vo_vpcmcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_MCSCDPUF0, NULL, cmucal_vclk_ip_lhs_ast_vo_mcscdpuf0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_MCSCNPUS, NULL, cmucal_vclk_ip_lhs_ast_vo_mcscnpus, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_MCSCVPC, NULL, cmucal_vclk_ip_lhs_ast_vo_mcscvpc, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_C2R_DPUF_MCSC, NULL, cmucal_vclk_ip_c2r_dpuf_mcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2R_NPUS_MCSC, NULL, cmucal_vclk_ip_c2r_npus_mcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_C2R_VPC_MCSC, NULL, cmucal_vclk_ip_c2r_vpc_mcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AD_AXI_D0_MCSC, NULL, cmucal_vclk_ip_ad_axi_d0_mcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AD_AXI_D1_MCSC, NULL, cmucal_vclk_ip_ad_axi_d1_mcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AD_AXI_D2_MCSC, NULL, cmucal_vclk_ip_ad_axi_d2_mcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AD_AXI_D3_MCSC, NULL, cmucal_vclk_ip_ad_axi_d3_mcsc, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_DPUF0MFC0, NULL, cmucal_vclk_ip_lhm_ast_vo_dpuf0mfc0, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_MFC0DPUF0, NULL, cmucal_vclk_ip_lhs_ast_vo_mfc0dpuf0, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_AXI_D0_NPU11, NULL, cmucal_vclk_ip_lhs_axi_d0_npu11, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AXI_D0_NPUS, NULL, cmucal_vclk_ip_lhs_axi_d0_npus, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AXI_D_CTRL_NPU11, NULL, cmucal_vclk_ip_lhs_axi_d_ctrl_npu11, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AXI_D_RQ_NPU11, NULL, cmucal_vclk_ip_lhm_axi_d_rq_npu11, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AXI_D_CMDQ_NPU11, NULL, cmucal_vclk_ip_lhm_axi_d_cmdq_npu11, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_AXI_D1_NPU11, NULL, cmucal_vclk_ip_lhs_axi_d1_npu11, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_AUDNPUS, NULL, cmucal_vclk_ip_lhm_ast_vo_audnpus, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_MCSCNPUS, NULL, cmucal_vclk_ip_lhm_ast_vo_mcscnpus, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_VPCNPUS, NULL, cmucal_vclk_ip_lhm_ast_vo_vpcnpus, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_NPUSAUD, NULL, cmucal_vclk_ip_lhs_ast_vo_npusaud, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_NPUSMCSC, NULL, cmucal_vclk_ip_lhs_ast_vo_npusmcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_NPUSVPC, NULL, cmucal_vclk_ip_lhs_ast_vo_npusvpc, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_CSISTAA, NULL, cmucal_vclk_ip_lhm_ast_vo_csistaa, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_TAADNS, NULL, cmucal_vclk_ip_lhs_ast_vo_taadns, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_C2R_TAA0, NULL, cmucal_vclk_ip_c2r_taa0, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_C2R_TAA1, NULL, cmucal_vclk_ip_c2r_taa1, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_LMETAA, NULL, cmucal_vclk_ip_lhm_ast_vo_lmetaa, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_TAALME, NULL, cmucal_vclk_ip_lhs_ast_vo_taalme, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AXI_D_VPD2VPC_CACHE, NULL, cmucal_vclk_ip_lhm_axi_d_vpd2vpc_cache, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AXI_D_VPD2VPC_SFR, NULL, cmucal_vclk_ip_lhm_axi_d_vpd2vpc_sfr, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AXI_D_VPD0VPC_CACHE, NULL, cmucal_vclk_ip_lhm_axi_d_vpd0vpc_cache, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AXI_P_VPCVPD2, NULL, cmucal_vclk_ip_lhs_axi_p_vpcvpd2, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AXI_D_VPCVPD2_SFR, NULL, cmucal_vclk_ip_lhs_axi_d_vpcvpd2_sfr, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_AXI_D_VPCVPD2_DMA, NULL, cmucal_vclk_ip_lhs_axi_d_vpcvpd2_dma, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_ACE_D_VPD0VPC_SCC, NULL, cmucal_vclk_ip_lhm_ace_d_vpd0vpc_scc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_ACE_D_VPD1VPC_SCC, NULL, cmucal_vclk_ip_lhm_ace_d_vpd1vpc_scc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_ACE_D_VPD2VPC_SCC, NULL, cmucal_vclk_ip_lhm_ace_d_vpd2vpc_scc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_AUDVPC, NULL, cmucal_vclk_ip_lhm_ast_vo_audvpc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_MCSCVPC, NULL, cmucal_vclk_ip_lhm_ast_vo_mcscvpc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_NPUSVPC, NULL, cmucal_vclk_ip_lhm_ast_vo_npusvpc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_VPCAUD, NULL, cmucal_vclk_ip_lhs_ast_vo_vpcaud, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_VPCMCSC, NULL, cmucal_vclk_ip_lhs_ast_vo_vpcmcsc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_VPCNPUS, NULL, cmucal_vclk_ip_lhs_ast_vo_vpcnpus, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHS_ACE_D_VPDVPC_SCC, NULL, cmucal_vclk_ip_lhs_ace_d_vpdvpc_scc, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_XIU_DP_VTS_20P5, NULL, cmucal_vclk_ip_xiu_dp_vts_20p5, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_AHB2AXI_CM40, NULL, cmucal_vclk_ip_ahb2axi_cm40, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AHB2AXI_CM41, NULL, cmucal_vclk_ip_ahb2axi_cm41, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AHB2AXI_CM42, NULL, cmucal_vclk_ip_ahb2axi_cm42, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_INTMEM_DATA, NULL, cmucal_vclk_ip_intmem_data, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_AHB2AXI_AHB1, NULL, cmucal_vclk_ip_ahb2axi_ahb1, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AHB2AXI_AHB2, NULL, cmucal_vclk_ip_ahb2axi_ahb2, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AHB2AXI_AHB3, NULL, cmucal_vclk_ip_ahb2axi_ahb3, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AHB2AXI_AHB4, NULL, cmucal_vclk_ip_ahb2axi_ahb4, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AHB2AXI_AHB5, NULL, cmucal_vclk_ip_ahb2axi_ahb5, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_ASYNCAXI1, NULL, cmucal_vclk_ip_asyncaxi1, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_ASYNCAXI2, NULL, cmucal_vclk_ip_asyncaxi2, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_ASYNCAXI3, NULL, cmucal_vclk_ip_asyncaxi3, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_ASYNCAXI4, NULL, cmucal_vclk_ip_asyncaxi4, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_ASYNCAXI5, NULL, cmucal_vclk_ip_asyncaxi5, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_YUVPP_CMU_YUVPP, NULL, cmucal_vclk_ip_yuvpp_cmu_yuvpp, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_AD_APB_YUVPP, NULL, cmucal_vclk_ip_ad_apb_yuvpp, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_IP_LHM_AST_VO_DNSYUVPP, NULL, cmucal_vclk_ip_lhm_ast_vo_dnsyuvpp, NULL, NULL),
	CMUCAL_VCLK(VCLK_IP_LHS_AST_VO_YUVPPDNS, NULL, cmucal_vclk_ip_lhs_ast_vo_yuvppdns, NULL, NULL),
