/*
 * s2mps23.h - Driver for the s2mps23
 *
...
#ifndef __S2MPS23_MFD_H__
#define __S2MPS23_MFD_H__
#include <linux/platform_device.h>
#include <linux/regmap.h>
#define MFD_DEV_NAME "s2mps23"
/**
 * sec_regulator_data - regulator data
 * @id: regulator id
 * @initdata: regulator init data (contraints, supplies, ...)
 */
struct s2mps23_regulator_data {
	int id;
