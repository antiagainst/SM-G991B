...
static inline int cpu_cooling_notifier_register(struct notifier_block *n)
{
	return 0;
}
...
#if defined(CONFIG_THERMAL_OF) && (defined(CONFIG_EXYNOS_CPU_THERMAL) || defined(CONFIG_EXYNOS_CPU_THERMAL_MODULE))
/**
 * of_cpufreq_cooling_register - create cpufreq cooling device based on DT.
 * @policy: cpufreq policy.
 */
