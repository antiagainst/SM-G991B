...
/* VTS will dump 4.4 sec data after every 2 minutes */
#define VTS_ADUIODUMP_AFTER_MINS	2
/* VTS will dump available log after every 1 minute */
#define VTS_LOGDUMP_AFTER_MINS		1
